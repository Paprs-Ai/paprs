  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl select-none">
        ...
        {/* V1 COLUMN (Fully Lit) */}
        <div className="bg-white border-2 border-[#16A34A]/30 p-8 rounded-lg shadow-md flex flex-col gap-6 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[#16A34A]/5 rounded-bl-full pointer-events-none"></div>
          <div>
            <h4 className="font-syne font-extrabold text-xl text-slate-950">V1 — Available Now</h4>
            <p className="text-xs text-slate-600 mt-1">Everything you need to successfully register and report.</p>
          </div>
          ...
          <ul className="flex flex-col gap-4 font-sans text-sm">
            {v1Items.map((item, index) => (
              <li key={index} className="flex items-center gap-3">
                <span
                  className="w-5 h-5 rounded-full bg-[#16A34A]/10 border border-[#16A34A]/30 flex items-center justify-center text-[#16A34A] transition-all duration-500"
                  style={{
        ...
        {/* V2 COLUMN (Dimmed / Pulse Indicator) */}
        <div className="bg-white border border-slate-200 p-8 rounded-lg shadow-sm flex flex-col gap-6 relative overflow-hidden group cursor-help opacity-75 hover:opacity-100 transition-all duration-300">
          <div>
            <h4 className="font-syne font-extrabold text-xl text-slate-950">V2 — Coming Next</h4>
            <p className="text-xs text-slate-600 mt-1">Autonomous agents filing and executing on your behalf.</p>
          </div>
          <hr className="border-slate-200" />
          ...
          <ul className="flex flex-col gap-4 font-sans text-sm opacity-60">
            {v2Items.map((item, index) => (
              <li key={index} className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 text-[10px]">
          ...
          <div className="absolute inset-0 bg-white/95 backdrop-blur-xs flex flex-col items-center justify-center p-6 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg">
            ...
            <p className="font-syne font-bold text-sm text-[#16A34A]">AI Agent Delegation</p>
            <p className="font-sans text-xs text-slate-600 mt-1.5 max-w-[240px] leading-relaxed">
